...
import LoadingScreen from "../../auth/components/LoadingScreen.jsx";
...
const Home = () => {
  ...
  const handleDelete = async (event, reportId) => {
    ...
    const confirmed = window.confirm(
      "Delete this interview report? This action cannot be undone."
    );
    ...
    try {
      const deleted = await deleteReportById(reportId);
      if (!deleted) {
  ...
  return (
    <div className="home-page">
      ...
      <header className="page-header">
        <h1>
          Create Your Custom <span className="highlight" style={{color:"white"}}>Interview Plan</span>
        </h1>
        <p>
